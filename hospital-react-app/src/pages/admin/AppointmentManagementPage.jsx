                    ...
                    <Col xs={6} className="d-flex">
                        <div className="info-block h-100 w-100">
                            <div className="avatar-container">
                                <Avatar src={appointment.patient?.avatar} name={appointment.patient?.name} size={90} />
                            </div>
                            <div className="name">{appointment.patient?.name || 'N/A'}</div>
                            <div className="specialty text-muted"><FaUserInjured className="me-2" /> Bệnh nhân</div>
                            <div className="info-block-detail"><FaBirthdayCake /> {appointment.patient?.dob || 'N/A'}</div>
                            <div className="info-block-detail"><FaPhone /> {appointment.patient?.phone || 'N/A'}</div>
                        </div>
                    </Col>
                    <Col xs={6} className="d-flex">
                        <div className="info-block h-100 w-100">
                            <div className="avatar-container">
                                <Avatar src={appointment.doctor?.avatar} name={appointment.doctor?.name} size={90} />
                            </div>
                            <div className="name">{appointment.doctor?.name || 'N/A'}</div>
                            <div className="specialty text-muted"><FaUserMd className="me-2" /> {appointment.doctor?.specialty || 'N/A'}</div>
                            <div className="info-block-detail"><FaEnvelope /> {appointment.doctor?.email || 'N/A'}</div>
                        </div>
                    </Col>
                </Row>
