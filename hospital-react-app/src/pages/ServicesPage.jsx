            ...
            <section id="our-services" className="padding-large" style={{
                ...
                <div className="container">
                    <div className="display-header text-center position-relative">
                        <h2 className="display-2 fw-bold text-white">Dịch vụ của chúng tôi</h2>
                    </div>
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="card-item p-4 my-4">
                                ...
                                <p className="card-paragraph">Khám sức khỏe tổng quát, hay còn gọi là khám sức khỏe định kỳ, là một phần cơ bản của việc chăm sóc sức khỏe dự phòng.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="card-item p-4 my-4">
                                ...
                                <p className="card-paragraph">Đây là chuyên khoa y tế chăm sóc sức khỏe hệ sinh sản của phụ nữ, bao gồm chẩn đoán và điều trị các bệnh lý.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="card-item p-4 my-4">
                                ...
                                <p className="card-paragraph">Dinh dưỡng là ngành khoa học nghiên cứu về ảnh hưởng của thực phẩm và đồ uống đến cơ thể, tập trung vào các chất dinh dưỡng cần thiết để hỗ trợ sức khỏe con người.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="card-item p-4 my-4">
                                ...
                                <p className="card-paragraph">Nhà thuốc là một cơ sở y tế được cấp phép để lưu trữ, cấp phát và bán các loại thuốc theo toa và không theo toa.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="card-item p-4 my-4">
                                ...
                                <p className="card-paragraph">Bạn có thể đặt lịch hẹn bằng cách gọi điện cho chúng tôi hoặc đặt trực tiếp từ trang web của chúng tôi một cách dễ dàng.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="card-item p-4 my-4">
                                ...
                                <p className="card-paragraph">Phòng khám của chúng tôi mở cửa 24/7. Vì vậy chúng tôi có thể giúp đỡ mọi bệnh nhân. Các bác sĩ của chúng tôi luôn sẵn sàng phục vụ bệnh nhân.</p>
                            </div>
                        </div>
                    </div>
                </div>
