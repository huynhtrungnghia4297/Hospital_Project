                                ...
                                <div className="card-item pe-3">
                                    <div className="card border-0 bg-transparent">
                                        <div className="card-image position-relative">
                                            ...
                                            <span
                                                className="bg-primary-dim text-light position-absolute text-uppercase text-capitalize">Y khoa</span>
                                        </div>
                                    </div>
                                    <div className="card-body p-3 mt-2">
                                        ...
                                        <h3 className="card-title fs-3 text-capitalize fw-semibold mt-3">
                                            <Link to="/blog/1">Lo âu là điều bình thường xảy ra với tất cả chúng ta</Link>
                                        </h3>
                                        <p>Việc cảm thấy lo lắng, phiền muộn và đau buồn là điều bình thường mỗi khi bạn được chẩn đoán mắc một bệnh nào đó... <Link to="/blog/1" className="text-decoration-underline"><em>Đọc thêm</em></Link>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="card border-0 bg-transparent">
                                        <div className="card-image position-relative">
                                            <Link to="/blog/1"> <img src="/images/post-item2.jpg" alt=""
                                                className="post-image img-fluid border-radius-top-10" /> </Link>
                                            <span
                                                className="bg-primary-dim text-light position-absolute text-uppercase text-capitalize">Sức khỏe</span>
                                        </div>
                                    </div>
                                    <div className="card-body p-3 mt-2">
                                        <div className="meta-date">26 tháng 1, 2023</div>
                                        <h3 className="card-title fs-3 text-capitalize fw-semibold mt-3">
                                            <Link to="/blog/1">Quyết định tốt nhất là kiểm tra sức khỏe của bạn</Link>
                                        </h3>
                                        <p>Việc cảm thấy lo lắng, phiền muộn và đau buồn là điều bình thường mỗi khi bạn được chẩn đoán mắc một bệnh nào đó... <Link to="/blog/1" className="text-decoration-underline"><em>Đọc thêm</em></Link>
                                        </p>
                                    </div>
                                    ...
                                    <div className="card border-0 bg-transparent">
                                        <div className="card-image position-relative">
                                            <Link to="/blog/1"> <img src="/images/post-item3.jpg" alt=""
                                                className="post-image img-fluid border-radius-top-10" /> </Link>
                                            <span
                                                className="bg-primary-dim text-light position-absolute text-uppercase text-capitalize">Sức khỏe răng miệng</span>
                                        </div>
                                    </div>
                                    <div className="card-body p-3 mt-2">
                                        <div className="meta-date">4 tháng 1, 2023</div>
                                        <h3 className="card-title fs-3 text-capitalize fw-semibold mt-3">
                                            <Link to="/blog/1">Những cách tốt nhất để giúp răng chắc khỏe</Link>
                                        </h3>
                                        <p>Việc cảm thấy lo lắng, phiền muộn và đau buồn là điều bình thường mỗi khi bạn được chẩn đoán mắc một bệnh nào đó... <Link to="/blog/1" className="text-decoration-underline"><em>Đọc thêm</em></Link>
                                        </p>
                                    </div>
