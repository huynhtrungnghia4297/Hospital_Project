                    ...
                    <div className="row py-4">
                        <div className="col-md-6 col-lg-3 pb-4">
                            <div className="py-5 plan-post text-center">
                                ...
                                <div className="price-option">
                                    ...
                                    <p><span className="price-tick">✓</span> Xét nghiệm máu</p>
                                    <p><span className="price-tick">✓</span> Tư vấn sức khỏe</p>
                                    <p><span className="price-tick">✓</span> Đo điện tâm đồ</p>
                                </div>

                                <Link to="/booking" className="btn btn-primary mt-3 px-4 py-3 mx-2 ">Đặt lịch ngay</Link>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-3 pb-4">
                            <div className="py-5 plan-post recommend-price text-center">
                                ...
                                <div className="price-option">
                                    <p className="text-white"><span className="price-tick text-white">✓</span> Khám tổng quát</p>
                                    <p className="text-white"><span className="price-tick text-white">✓</span> Xét nghiệm máu</p>
                                    <p className="text-white"><span className="price-tick text-white">✓</span> Tư vấn sức khỏe</p>
                                    <p className="text-white"><span className="price-tick text-white">✓</span> Siêu âm ổ bụng</p>
                                    <p className="text-white"><span className="price-tick text-white">✓</span> Đo điện tâm đồ</p>
                                </div>

                                <Link to="/booking" className="btn btn-primary text-black mt-3 px-4 py-3 mx-2"
                                    style={{ background: 'white' }}>Đặt lịch ngay</Link>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-3 pb-4">
                            <div className="py-5 plan-post text-center">
                                ...
                                <h2 className="heading-color display-5 fw-bold mb-5">2.585.000 VNĐ</h2>
                                <div className="price-option">
                                    <p><span className="price-tick">✓</span> Khám tổng quát</p>
                                    <p><span className="price-tick">✓</span> Xét nghiệm máu</p>
                                    <p><span className="price-tick">✓</span> Tư vấn sức khỏe</p>
                                    <p><span className="price-tick">✓</span> Đo điện tâm đồ</p>
                                    <p><span className="price-tick">✓</span> Siêu âm ổ bụng</p>
                        ...
                        <div className="col-md-6 col-lg-3 pb-4">
                            <div className="py-5 plan-post text-center">
                                ...
                                <h2 className="heading-color display-5 fw-bold mb-5">4.765.000 VNĐ</h2>
                                <div className="price-option">
                                    <p><span className="price-tick">✓</span> Khám tổng quát</p>
                                    <p><span className="price-tick">✓</span> Xét nghiệm máu</p>
                                    <p><span className="price-tick">✓</span> Tư vấn sức khỏe</p>
                                    ...
                                    <p><span className="price-tick">✓</span> Siêu âm ổ bụng</p>
                                    <p><span className="price-tick">✓</span> Chụp X-quang</p>
                                    <p><span className="price-tick">✓</span> Nội soi dạ dày</p>
                                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="display-header text-light d-flex flex-wrap justify-content-between padding-medium">
                            <div className="col-lg-5 col-md-6 col-sm-12">
                                <h2 className="text-light">Dịch vụ tốt nhất cho sức khỏe của bạn</h2>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-12">
                                <p className="text-light">Chúng tôi cung cấp các dịch vụ y tế chất lượng cao, giúp bạn giải quyết các vấn đề sức khỏe một cách hiệu quả và an toàn.</p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 pb-3">
                            <div className="icon-box p-4 bg-light border-radius-10 text-center">
                                ...
                                <div className="icon-box-content">
                                    ...
                                    <p>Đội ngũ bác sĩ giàu kinh nghiệm luôn sẵn sàng chăm sóc sức khỏe cho bạn.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6 pb-3">
                ...
                <div className="container">
                    <div className="row">
                        <div className="display-header">
                            <h2 className="display-5 fw-bold text-dark">Đặt lịch hẹn hoặc gọi: <span className="text-primary-500">
                                (028) 3865 1234</span></h2>
                        </div>
                        <form className="contact-form d-flex flex-wrap mt-5 gx-1">
                            <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                                <select className="form-select focus-transparent border border-radius-10 ps-4" aria-invalid="false"
                                    name="choose">
                                    <option value="Select Your Department">Chọn chuyên khoa</option>
                    ...
                    <a href="/booking" className="btn btn-medium btn-primary btn-pill mt-3 text-uppercase">Đặt lịch hẹn</a>
                </div>
            </section>
        </>
    );
